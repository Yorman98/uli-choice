...
class AttributeController extends Controller
{
     ...
     *
     * @return JsonResponse  A JSON response containing the list of attributes if successful.
     ...
     *
     * @param Request $request  The HTTP request object containing the new attribute data (name and attribute_group_id).
     *
     ...
     *
     * @param Request $request  The HTTP request object. (Note: The request is not used in this function, but it's part of the method signature.)
     * @param  int  $id  The ID of the attribute to be retrieved.
     *
     * @return JsonResponse  A JSON response containing the attribute details if found.
     ...
     *
     * @param Request $request  The HTTP request object containing the updated attribute data (ID, name, and attribute_group_id).
