...
<template>
  <VContainer>
    <VRow class="cart-container">
      <VCol cols="12">
        <UCHeaderPage class="mb-5" :title="$t('cart.my_product_list')" :path="path" />
      </VCol>
      ...
      <VCol cols="8">
        <VCard class="pa-0">
          <VCard-title class="px-0 py-2">
            <VRow class="header-cart pa-4">
              <VCol cols="6" class="pa-0">
                <p class="text-body-1 text-white text-center ma-0">
                  {{ $t("cart.product") }}
                </p>
              </VCol>
          ...
          <VCardText class="py-4 px-0">
            <VRow
              v-for="(product, index) in cartStore.productsCart"
              class="product-data px-4"
              :key="index"
            >
